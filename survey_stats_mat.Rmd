...
Same approach as above but the scale goes from 1 (extremely useful) to 5 (not useful at all).
...
us <- gsub("Not at all useful","5",us)
us1 <- as.numeric(us)
us1
mean(us1)
...
t.test(us1,us2)
```
Students ranked both classes between 1 and 2 for utility and there was no significant difference.

### How satified students were with the classes (Q5 v Q11).

Dissatisaction was on a scale of 1 (extremely satisfied) to 7 (extremely dissatisfied).
